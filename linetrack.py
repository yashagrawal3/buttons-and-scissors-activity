...
class linetrack:
    ...
    def displayline(self, gameDisplay):
        ...
        pygame.draw.line(gameDisplay, white, start_pos,
                         (self.horizontalleft), 3)  # horizontalleft

        pygame.draw.line(gameDisplay, white, start_pos,
                         (self.horizontalright), 3)  # horizontalright

        pygame.draw.line(gameDisplay, white, start_pos,
                         (self.verticalup), 3)  # verticalup

        pygame.draw.line(gameDisplay, white, start_pos,
                         (self.verticaldown), 3)  # verticaldown

        pygame.draw.line(gameDisplay, white, start_pos,
                         (self.leftdiagup), 3)  # leftdiagup

        pygame.draw.line(gameDisplay, white, start_pos,
                         (self.leftdiagdown), 3)  # leftdiagdown

        pygame.draw.line(gameDisplay, white, start_pos,
                         (self.rightdiagup), 3)  # rightdiagup

        pygame.draw.line(gameDisplay, white, start_pos,
                         (self.rightdiagdown), 3)  # rightdiagdown
