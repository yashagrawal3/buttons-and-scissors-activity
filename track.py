...
class scissorrun:
    ...
    def display(self, gameDisplay):
        ...
        right1 = pygame.transform.scale(
            pygame.image.load("scissor/s1.png"), (180, 100))
        right2 = pygame.transform.scale(
            pygame.image.load("scissor/s2.png"), (180, 100))
        right3 = pygame.transform.scale(
            pygame.image.load("scissor/s3.png"), (180, 100))
        ...
        if y1 == y2 and x1 < x2:
            ...
            gameDisplay.blit(frameleft[self.k],
                             (100 - 50 + self.x + 50 + 280, y1 - 25))
        ...
        if y1 == y2 and x1 > x2:
            ...
            gameDisplay.blit(frameright[self.k],
                             (850 + self.x - 50 + 280, y1 - 25))
        ...
        if x1 - y1 == x2 - y2 and (x1 < x2):
            ...
            gameDisplay.blit(framedownleft[
                             self.k], (-20 + self.x + 200 + 10 + 280, 200 - 20 - (x1 - y1) + self.x + 10 + 280))
            ...
            self.cp = (self.x - 20 + 65 + 260 + 280, -20 -
                       (x1 - y1) + self.y + 65 + 260 + 280)
        ...
        if x1 + y1 == x2 + y2 and (x1 > x2):
            ...
            gameDisplay.blit(framedownright[
                             self.k], (820 + self.x - 90 + 280 - 100, (x1 + y1) - self.x - 820 - 140 + 90 - 280 + 100))
            ...
            self.cp = (820 + self.x + 65 - 90 + 280,
                       (x1 + y1) - self.x - 820 - 12 + 90 - 280)
        ...
        if x1 + y1 == x2 + y2 and (x1 < x2):
            ...
            gameDisplay.blit(frameupleft[
                             self.k], (-20 + self.x + 150 + 280, (x1 + y1) - self.x + 20 - 140 - 5 - 150 - 280))
            ...
            self.cp = (-20 + self.x + 120 + 150 + 280, (x1 + y1) -
                       self.x + 20 - 60 - 5 - 150 - 280)
        ...
        if x1 - y1 == x2 - y2 and (x1 > x2):
            ...
            gameDisplay.blit(frameupright[
                             self.k], (820 + self.x - 100 + 280, 820 - (x1 - y1) + self.x - 100 + 280))
            ...
            self.cp = (820 + self.x + 80 - 100 + 280, 820 -
                       (x1 - y1) + self.x + 80 - 100 + 280)
